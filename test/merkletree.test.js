// https://github.com/miguelmota/merkletreejs-solidity/blob/master/test/merkleproof.js
const MerkleProof = artifacts.require('Tools')
    ...
    context('MerkleProof', () => {
        describe('merkle proofs', () => {
            it('should return true for valid merkle proof (example)', async () => {
                ...
                console.log(root, buf2hex(leaf), proof)
                const verified = await contract.verify.call(root, buf2hex(leaf), proof)
