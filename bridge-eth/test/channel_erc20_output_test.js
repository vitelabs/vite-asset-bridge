...
describe("Channel Inputs Outputs", function () {
  ...
  it("Should output", async function () {
    ...
    await erc20.transfer(channel.address, ethers.utils.parseEther("1.0"));

    const dest = "0x09FDAD54B23D937BDB6244341b24566e5F79309b";

    const balanceOfZeroBefore = await erc20.balanceOf(dest);
    ...
    const balanceOfZero = await erc20.balanceOf(dest);
    assert.equal(
